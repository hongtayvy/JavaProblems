...
public class StringProblem {
    /**
     * We are going to build some research skills along with some good String methods that you should know.
     * The problem is that we are going to take a full name and split it into two. A firstName and lastName.
     ...
     *              String hello = helloWorld.substring(indexOfHello + 1); //This will cut from the H to the first o so you'll get "Hello"
